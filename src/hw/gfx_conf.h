...
class Panel_CrowPanel70 : public lgfx::LGFX_Device
{
public:
...
// // Typedef to match LovyanGFX's LGFX name with our custom panel (only for CrowPanel_70)
#if defined(CrowPanel_70)
typedef Panel_CrowPanel70 LGFX;
#endif

// Do not define the global `tft` here to avoid multiple-definition when
// building with PlatformIO. The single definition lives in `src/gfx_conf.cpp`.
extern LGFX tft;
