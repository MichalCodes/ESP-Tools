...
public:
    ...
    void update() {
        ...
        // Ve FreeRTOS už NEVOLÁME handleAudio() - obstarává MusicTask v main.cpp

        int touchX, touchY;
        swipe.update();

        // Obsluha tlačítka Back
        ...
        // Malá prodleva pro stabilitu UI tasku
...
private:
    ...
    // Logika pohybu zůstává stejná, je efektivní
    bool moveLeft() {
        bool moved = false;
        for(int i=0;i<N;i++){
            int target = 0;
    ...
    void handleSwipe() {
        ...
        if(moved) {
            ...
            // Debounce po swipu, aby RTOS nezachytil jeden pohyb 2x
            vTaskDelay(pdMS_TICKS_TO_MS(200));
        }
    }

    uint16_t getTileColor(int value) {
        switch(value) {
            case 0:   return TFT_DARKGREY;
            case 2:   return 0xFFFF;      
            case 4:   return 0xEF5D;      
            case 8:   return 0xFDB8;      
            case 16:  return 0xFD20;      
            case 32:  return 0xFC60;      
            case 64:  return 0xF800;      
            case 128: return 0xFFE0;      
            case 256: return 0xFFC0;      
            case 512: return 0xFF80;      
    ...
    void showGameOver() {
        ...
        vTaskDelay(pdMS_TICKS_TO_MS(3000));
        exitGame();
    }
};